...
const TodoList = ({ adminView = false }) => {
    ...
    const getTodo = async () => {
        try {
            const url = "https://skillcraftserver.onrender.com/todo/gettodo";
    ...
    const postTodo = async () => {
        try {
            await axios.post(
                "https://skillcraftserver.onrender.com/todo/addtodo",
                { todo },
                { headers: { Authorization: `Bearer ${token}` } }
            );
            setTodo('');
    ...
    const deleteTodo = async (id) => {
        try {
            await axios.delete(`https://skillcraftserver.onrender.com/todo/deletetodo/${id}`, {
                headers: { Authorization: `Bearer ${token}` },
            });
            getTodo();
        } catch (err) {
    ...
    const updateTodo = async (id, data) => {
        try {
            await axios.put(
                `https://skillcraftserver.onrender.com/todo/updatetodo/${id}`,
                { todo: data },
                { headers: { Authorization: `Bearer ${token}` } }
            );
            getTodo();
    ...
    const completeTodo = async (id) => {
        try {
            await axios.put(
                `https://skillcraftserver.onrender.com/todo/complete/${id}`,
                {},
                {
                    headers: {
